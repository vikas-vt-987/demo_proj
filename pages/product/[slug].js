...
const Post = ({ addToCart, buyNow, product, variants }) => {
  ...
  const checkService = async () => {
    ...
    // {
    //   setService(true)
    //   toast.success('The dilevery is avaliabe on your pincode', {
    ...
    // else{
    //   setService(false)
    //   toast.error('Sorry ,the dilevery is not avaliabe on your pincode', {
    //     position: "bottom-center",
    //     autoClose: 3000,
    //     hideProgressBar: false,
    //     closeOnClick: true,
      ...
      <div className="container px-5 py-24 mx-auto min-h-screen ">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">{product.title} </h1>  {/*Stone 1500*/}
            ...
            <div className="flex">
              ...
              <button onClick={() => { buyNow(slug, 1, product.price, product.title, 'blue') }} className="flex ml-14 text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Buy Now</button>
              <button onClick={() => { addToCart(slug, 1, product.price, product.title, 'blue') }} className="flex ml-14 text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Add to Cart</button>
            ...
            <div className="pin mt-6 flex space-x-2 text-sm">
              <input onChange={onChangePin} className='px-2 border-2 border-gray-300' type="text" />
            ...
            {service && service != null && <div className="text-green-500 text-sm mt-3">
              <p> yeah, service available</p>
            </div>}
            {/* <div className='bg-red-900 rounded-[100%]  w-10 h-10  text-gray-200 text-center' > 0 </div> */}
          </div>
        </div>
      </div>
    </section>
